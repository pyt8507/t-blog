...
<ul id="navigation_bar">
    ...
    <li class="navigation_bar_li_nothome" id="navigation_current"><a id="navigation_bar_a" href="register.jsp">注册</a></li>
...
<div id="main">
    ...
    <hr>
    <form action="registerServlet" meth="post">
        <table>
            <tr>
                <td>用户名：</td>
        ...
        <input type="submit" value="注册" id="inputbutton">
    </form>
<p>
