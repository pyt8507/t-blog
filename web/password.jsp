...
<jsp:useBean id="passwordBean" class="save.data.Password" scope="request"/>
<jsp:useBean id="sessionBean" class="save.data.Login" scope="session"/>
<!DOCTYPE html>
<html>
<head>
    <title>注册 | t博客 t-blog</title>
</head>
<style>
    html {
...
<div id="main">
    ...
    <hr>
    <form action="passwordServlet" meth="post">
        <table>
            <tr>
                <input type="text" name="userid" hidden="true" value=<%=sessionBean.getId()%>>
                <td>用户名：</td>
                <td><%=sessionBean.getUsername()%></td>
            </tr>
            <tr>
                <td>旧密码：</td>
                <td><input type="password" name="oldPassword" id="inputbox"></td>
            </tr>
            <tr>
                <td>新密码：</td>
                <td><input type="password" name="newPassword" id="inputbox"></td>
            </tr>
            <tr>
                <td>确认密码：</td>
                <td><input type="password" name="again_Password" id="inputbox"></td>
            </tr>
            <tr>
                <td>验证码：</td>
...
<p>
    <% if(passwordBean.getResult()!=null){%>
    <jsp:getProperty name="passwordBean" property="result"/>
    <% } %>
</p>
</div>
</body>
